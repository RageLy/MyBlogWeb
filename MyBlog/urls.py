...
urlpatterns = [
    ...
    path('commenttocommentdata/', views.commenttocommentdata, name='commenttocommentdata'),
    path('commenttoreplydata/', views.commenttoreplydata, name='commenttoreplydata'),
